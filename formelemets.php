        ...
        <form class="form-horizontal">
          <fieldset>
            ...
            <div class="control-group">
              ...
              <div class="controls">
                <textarea name="textarea" rows="3" class="cleditor" id="textarea2"></textarea>
              </div>
            </div>
        ...
        <form class="form-horizontal">
          <fieldset>
            ...
            <div class="control-group">
              ...
              <div class="controls">
                <select name="selectError" id="selectError3">
            ...
            <div class="control-group">
              ...
              <div class="controls">
                <select name="selectError" multiple id="selectError1" data-rel="chosen">
                  <option>Option 1</option>
            ...
            <div class="control-group">
              ...
              <div class="controls">
                <select name="selectError" id="selectError2" data-placeholder="Your Favorite Football Team" data-rel="chosen">
                  <option value=""></option>
